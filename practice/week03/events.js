...
function manageTasks(event) {
  ...
  // because we added 'data-function="delete"' to each icon in a task we can access
  // a dataset property on our target
...
// Listen for a click, call the 'newTask' function on submit and call the 'manageTasks'
